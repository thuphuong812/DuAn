         ...
         <div class="tab-content" id="myTabContent">  
             ...
             <div class="col-12">
									<div class="block_title">
										<h3>DANH MỤC: <?php echo $name?></h3>
									</div>
								</div> 
                    <div class="row"><?php
                    foreach ($category_by_id as $key => $products) {
...
<div>
                               ...
                               <?php
                                 ...
                                 if ($products['quantity_product'] > 0){
                                     ...
                                     <h3 class="product_title"><a href="<?php echo BASE_URL ?>sanpham/detail_product/<?php echo $products['id_product']?>"><?php echo $products['title_product']?></a></h3>
                                 </div>
