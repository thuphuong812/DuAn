              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">
                      ...
                      if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        if (empty($_POST["title_product"])) {
                          ...
                          $name = test_input($_POST["title_product"]);
                        }
                      }
                    ...
                    <!-- action="<?php echo BASE_URL ?>product/insert_product" -->
                    <form class="forms-sample" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  method="POST" enctype="multipart/form-data"  >
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Tên sản phẩm" name="title_product" maxlength="255" >
